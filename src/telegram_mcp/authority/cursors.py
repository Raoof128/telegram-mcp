...
from telegram_mcp.authority.refs import validate_ref_format
from telegram_mcp.consent.challenge import jcs_dumps  # single JCS implementation
from telegram_mcp.opaque import mint_opaque_ref

if TYPE_CHECKING:
    from collections.abc import Iterable, Mapping

    from telegram_mcp.authority.policy import AuthorityView
